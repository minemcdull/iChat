...
CREATE TABLE `friendlist` (
  ...
  `liststatue` int(11) DEFAULT NULL,
  `username` varchar(45) DEFAULT NULL,
  `friendname` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`listID`),
  KEY `username_idx` (`username`),
  CONSTRAINT `user` FOREIGN KEY (`username`) REFERENCES `login` (`UserName`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `friendlist` VALUES (1,0,'Auser','Buser'),(2,0,'Buser','Auser');
